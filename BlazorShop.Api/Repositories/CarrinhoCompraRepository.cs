...
public class CarrinhoCompraRepository : ICarrinhoCompraRepository
{
    ...
    {
        return await _context.CarrinhoItens.AnyAsync(i => i.CarrinhoId == carrinhoId &&
    ...
    public async Task<IEnumerable<CarrinhoItem>> GetItensByUsuario(int usuarioId)
    {
        var itens = await (from carrinho in _context.Carrinhos
                           join carrinhoItem in _context.CarrinhoItens
